...
export const getHeroText = () => {
  return (
    <p className="max-w-screen-xl text-left text-lg dark:text-slate-500">
      I&apos;m a{" "}
      <strong>
        JavaScript developer with a proactive, problem solving attitude
      </strong>
      . Since 2016 working with clients building company and e-commerce
      websites. In 2021 covered a role as Junior Frontend Developer at
      iGamingNuts for 2+ years.{" "}
      <strong>
