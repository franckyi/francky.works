...
let workList: IWork[] = [
  {
    title: "nowa strona internetowa + logo",
    client: "Godere.pl",
    ...
    myRole: ["logo", "UI/UX", "web development"],
    stack: ["inkscape", "Affinity Designer", "angular", "typescript"],
  ...
  },
  {
    ...
    myRole: ["logo", "UI/UX", "web development"],
    stack: ["inkscape", "affinity designer", "wordpress"],
    gitUrl: null,
